...
then
	printf "\\n\\nUpdating buildAPKs\; \`%s\` might need to load sources from module repositories into buildAPKs. This may take a little while to complete. Please be patient if this script needs to download source code from https://github.com\\n" "${0##*/}"
	git pull 
