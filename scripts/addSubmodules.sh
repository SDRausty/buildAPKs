...
#####################################################################
git submodule add https://github.com/sdrausty/buildAPKsApps sources/apps
git submodule add https://github.com/sdrausty/buildAPKsAmusements sources/amusements
