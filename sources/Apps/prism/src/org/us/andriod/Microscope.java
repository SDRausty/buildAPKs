 ...
 */
public class Microscope extends Rays {

	/**
	 * Initializes the variables needed and sets up the GridObject settings
	 */
	public Microscope(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public Microscope(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public Microscope(Context context) {
		super(context);
	}
