 ...
 */
public class Telescope extends Rays {

	/**
	 * Initializes the variables needed and sets up the GridObject settings
	 */
	public Telescope(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public Telescope(Context context, AttributeSet attrs, int defStyle) {
