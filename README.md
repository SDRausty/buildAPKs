...
The [`buildAll.sh`](https://raw.githubusercontent.com/sdrausty/buildAPKs/master/scripts/build/buildAll.sh) command shall build hundreds of APKs on your device.  Maximum space allotment for complete build of everything available is about 1022MB for buildAPKs and all the submodules, plus about 65MB for the finished products deposited into /sdcard/Download/builtAPKs; 590 Android applications are made from source code on device. 
